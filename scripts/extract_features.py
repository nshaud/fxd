...
from datasets import DatasetDict as HFDataset
...
class SimpleImageFolder(Dataset):
    ...
    def __getitem__(self, idx: int) -> Image.Image | Tensor:
...
def extract_features_from_dataset(
    input: SimpleImageFolder | MinIODataset | VisionDataset | HFDataset,
    ...
    # TODO: pre-allocate memory to store features?
    out = None
