...
def fid_infinity_from_feats(
    ...
    seed: int | None = None,
    reference_statistics: tuple[NDArray, NDArray] | None = None,
    plot: bool = False,
    progress: bool = False,
) -> float:
    """
    ...
    --------------------------------------------------------------------------
        ...
        reference_statistics: (tuple, optional)
            Precomputed reference mean and covariance. If supplied, the statistics
            of ``reference_feats`` are not recomputed.
        plot: (bool)
    ...
    # Precompute the reference statistics (mean and covariance) for the real dataset, unless supplied by the caller.
